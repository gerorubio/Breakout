...
function GenerateQuadsBricks(atlas)
    ...
    r = table.slice(GenerateQuads(atlas, 32, 16), 1, 21)
    
    x = 160
    y = 48

    table.insert(r, love.graphics.newQuad(x, y, 32, 16, atlas:getDimensions()))
...
--[[
    This function is specifically made to piece out the powers from the
    sprite sheet.
]]
